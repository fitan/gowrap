...
const DTOMethodName = "@dto-method"
...
func (d *DTO) GenExtraDTOMethod(bind *jen.Statement, destV, srcV Field) (has bool) {
	pkgName, methodName := destV.DTOMethod()
