...
import (
	...
	"github.com/fitan/gowrap/generator/test_data/encode"
...
const (
	...
	HelloBodyMethodName = "HelloBody"

	SayHelloMethodName = "SayHello"
)
...
func NewEndpoint(s Service, dmw map[string][]endpoint.Middleware) Endpoints {
	eps := Endpoints{
		...
		HelloBodyEndpoint: makeHelloBodyEndpoint(s),
