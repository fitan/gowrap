...
//go:generate gowrap gen -p github.com/fitan/gowrap/templates_tests -i InterfaceWithValidtableArg -t ../templates/grpc_validate -o interface_with_grpc_validation.go -l ""
