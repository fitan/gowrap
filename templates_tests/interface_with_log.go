...
//go:generate gowrap gen -p github.com/fitan/gowrap/templates_tests -i TestInterface -t ../templates/log -o interface_with_log.go -v DecoratorName=TestInterfaceWithLogger -l ""
