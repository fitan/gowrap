...
//go:generate gowrap gen -p github.com/fitan/gowrap/templates_tests -i TestInterface -t ../templates/opentelemetry -o interface_with_opentelemetry.go -v DecoratorName=TestInterfaceWithOpentelemetry -l ""
