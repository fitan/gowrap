...
//go:generate gowrap gen -p github.com/fitan/gowrap/templates_tests -i InterfaceWithValidtableArg -t ../templates/twirp_validate -o interface_with_twirp_validation.go -l ""
